		...
		<c:if test="${allowedall == true }">
			...
			<div class="pt-5 container">
				...
				<div class=" row justify-content-center">
					...
					<div class="col-md-8">
						<form:form action="${pageContext.request.contextPath}/employees"
							...
							<div class="form-group">
								...
								<form:select class="form-control" path="roles" items="${roles}"
									itemLabel="name" itemValue="id" />
							</div>

							<form:hidden path="id" />
							<a class="btn btn-info"
								href="${pageContext.request.contextPath}/employees">Back to
								list</a>
